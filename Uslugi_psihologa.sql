...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 20 2023 г., 15:27
...
CREATE TABLE `clients` (
  ...
  `id_consultation` int DEFAULT NULL COMMENT 'ID консультации'
...
INSERT INTO `clients` (`id`, `name`, `birthdate`, `id_consultation`) VALUES
(1, 'Иванов Михаил Васильевич', '1993-07-15', 1),
(2, 'Зубенко Владимир Константинович ', '2001-09-15', 2),
(3, 'Горбачева Анастасия Владимировна', '1998-02-02', NULL),
(4, 'Соева Марина Павловна', '1988-07-02', NULL);
...
CREATE TABLE `notes_on_the_consultation` (
  ...
  `consultation_date` date DEFAULT NULL COMMENT 'Дата консультации'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
--
ALTER TABLE `clients`
  ADD CONSTRAINT `clients_ibfk_2` FOREIGN KEY (`id_consultation`) REFERENCES `notes_on_the_consultation` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
